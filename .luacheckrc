...
-------------------------------------------------------------------------------
--[[Set Defaults]] local LINE_LENGTH = false -- It is 2017 limits on length are a waste
...
-------------------------------------------------------------------------------
--[[Assume Factorio Control stage as default]] std = STD_CONTROL
...
-------------------------------------------------------------------------------
--[[Mod Prototypes]] --Set default prototype files
...
-------------------------------------------------------------------------------
--[[Base]] --Find and replace ignores *.cfg, migrations, *.txt, control.lua, *.json, trailer, scenarios, campaigns, *.glsl
...
-------------------------------------------------------------------------------
--[[Set STDLIB project modules]] local stdlib_control = {
